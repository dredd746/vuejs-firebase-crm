<template>
      ...
      >
        ...
        <td>{{record.categoryName }}</td>
          ...
          <!-- <br>
          <button class="btn-small btn yellow" @click="change_status(record.name,record.id,'waiting')">
            <i class="material-icons">access_time</i>
          </button>
          <button class="btn-small btn red" @click="change_status(record.name,record.id,'declined')">
            <i class="material-icons">remove_circle</i>
          </button>
          <button class="btn-small btn " @click="change_status(record.name,record.id,'working')">
            <i class="material-icons">work</i>
          </button>
          <button  class="btn-small btn black" @click="change_status(record.name,record.id,'completed')">
    ...
    methods: {
      async change_status(name,id,status){
        ...
        const newData = {
          ...
          this.$message(`Statutul muncitorului ${name} a fost schimbat pe ${status}`)
        },
         test(id) {
            this.$message(id)
        }
